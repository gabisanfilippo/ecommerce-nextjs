...
export const SearchIcon: FC<IProps> = ({ fill, size, onClick }) => {
  return (
    <svg
      width={size ? size : "16"}
      height={size ? size : "16"}
    ...
    >
      ...
      <path
        ...
        fill={fill ? fill : "var(--color-dark-primary)"}
      />
    </svg>
  );
};

export const CartIcon: FC<IProps> = ({ fill, size, onClick }) => {
  return (
    <svg
      width={size ? size : "16"}
      height={size ? size : "16"}
...
export const ProfileIcon: FC<IProps> = ({ fill, size, onClick }) => {
  return (
    <svg
      width={size ? size : "16"}
      height={size ? size : "16"}
...
export const HamburguerIcon: FC<IProps> = ({ fill, size, onClick }) => {
  return (
    <svg
      width={size ? size : "16"}
      height={size ? size : "16"}
...
export const CloseIcon: FC<IProps> = ({ fill, size, onClick }) => {
  return (
    <svg
      width={size ? size : "24"}
      height={size ? size : "24"}
